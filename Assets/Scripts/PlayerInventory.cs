...
public class PlayerInventory : MonoBehaviour
{
    ...
    public int slotCount
    {
        ...
        set
        {
            ...
            GameObject.Find("DialogManager").GetComponent<DialogManager>().playerData.inventorySize = slotCnt;
        }
    }

    void Start()
    {
        slotCount = GetComponent<DialogManager>().playerData.inventorySize;
