...
public class ShopInformation : MonoBehaviour
{
    ...
    public void purchaseItem()
    {
        ...
        if (GameObject.Find("DialogManager").GetComponent<DialogManager>().playerData.money >= item.price * purchaseCount)
        {
            if (PlayerInventory.instance.addItem(item, purchaseCount))
            {
                item.count = tempCount;
                GameObject.Find("DialogManager").GetComponent<DialogManager>().playerData.money -= item.price * purchaseCount;
                ...
                GameObject.Find("Canvas").GetComponent<ShopUI>().money.text = "" + GameObject.Find("DialogManager").GetComponent<DialogManager>().playerData.money;
                offInformation();
    ...
    public void sellItem()
    {
        ...
        {
            item.count = tempCount;
            GameObject.Find("DialogManager").GetComponent<DialogManager>().playerData.money += item.price * sellCount;
